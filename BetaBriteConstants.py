...
# https://github.com/jonathankoren/betabrite/blob/141111ffc94d5f12a83b5072e4b4a7e3cd7e191f/betabrite.py
...
CHAR_FLASH_ON = b"\x07\x31"  # character flash off (default)
...
u_E_ACCENT = b"\x90"  # capital 'e' with accent
